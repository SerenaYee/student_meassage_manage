                                ...
                                <form action="${pageContext.request.contextPath}/addGrade"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button href="#modal-table" data-toggle="modal fade"
                                                    class="btn btn-sm btn-primary pull-right"><i
                                                    class="ace-icon glyphicon glyphicon-plus"></i>添加</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                                <button type="button" class="btn btn-purple btn-sm " id="update-grade-name">
