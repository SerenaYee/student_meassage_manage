...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                <div class="page-header"> <h1>学生信息</h1></div><!-- /.page-header -->
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <div class="row">
                            <div class="col-xs-12">
                                <div><button href="#modal-form" data-toggle="modal"
                                ...
                                <br>
                                <table id="simple-table" class="table  table-bordered table-hover" style="margin: 0px">
                                    <thead>
                                    <tr>
                                        <th>序号</th>
                                        <th>学号</th>
 ...
 <%--************************************************************************************************************************************************************************--%>
                                                 <%--   <button  class="btn btn-sm btn-primary pull-right"
                                                             href="#modal-subject?id=${studentVO.id}"  data-toggle="modal">
                                                        <i class="ace-icon fa fa-check bigger-120"></i>选课</button>--%>
                                                        <%--
...
<div id="modal-subject" class="modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="blue bigger">选课信息</h4>
            </div>
            <form class="form-horizontal" role="form" id="studentAddSubject"
                  action="studentAddSubject" method="post">
